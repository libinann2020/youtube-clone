                    ...
                    <div v-for="video in videos" :key="video">
                        <tr class="border-b flex justify-between">
                            <td class="px-6 py-4 w-7/12 text-sm font-medium text-gray-900">
                                <video :src="video.video || ''" controls type="video/mp4" width="320"></video>
                            </td>
                            <td class="px-6 py-4 w-5/12 text-sm font-medium text-gray-900 relative">
                                ...
                                <div class="w-full">
                                    <Link as="button" method="delete" :href="route('videos.destroy', { id: video.id})" class="text-white absolute bottom-4 right-4 text-xs bg-red-600 hover:bg-red-700 font-bold py-1 px-1 float-right rounded cursor-pointer">
                                        Delete
                                    </Link>
                                </div>
                            </td>
